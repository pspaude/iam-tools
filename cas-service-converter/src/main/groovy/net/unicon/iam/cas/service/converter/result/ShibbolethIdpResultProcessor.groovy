...
class ShibbolethIdpResultProcessor extends ResultProcessor {
    ...
    def outputShibCASUsernames() {
        try {
            ...
            println "Error outputting Shibb CAS Usernames! " + e
        }
    }
    ...
    def outputShibCASServicesAndAttributes(resultFormat) {
        try {
            ...
            } else if (resultFormat?.equalsIgnoreCase(ResultFormats.shibmetadata.toString())) {
            ...
            println "Error outputting Shibb CAS Services! " + e
        }
    }
    ...
    def outputShibCASAttributes(isBeanDef) {
        try {
            ...
            println "Error outputting Shibb Attributes! " + e
        }
    }
}
