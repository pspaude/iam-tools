...
def cli = new CliBuilder(
    ...
    usage: 'CASServiceConverter.groovy -currentformat cas3json|casjson|shibxml|shibmetadata -currentdir pathToFileOrDir -resultformat casjson|shibxml|shibmetadata -resultlocation pathToResultLocation',
...
//Globals
originalFormats = ["cas3json", "casjson", "shibxml", "shibmetadata"]
resultFormats = ["cas5json", "shibxml", "shibmetadata"]
